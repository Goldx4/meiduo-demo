...
class Address(BaseModel):
    ...
    place = models.CharField(max_length=50, verbose_name='地址', help_text='地址')
    mobile = models.CharField(max_length=11, verbose_name='手机')
    tel = models.CharField(max_length=20, null=True, blank=True, default='', verbose_name='固定电话', help_text='固定电话')
    email = models.CharField(max_length=30, null=True, blank=True, default='', verbose_name='电子邮箱', help_text='电子邮箱')
